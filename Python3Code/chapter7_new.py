...
DATASET_FNAME4 = 'physionet_8692923_chapter5_result.csv'
RESULT_FNAME = 'chapter7_classification_physionet_result.csv'
...
try:
    ...
    dataset4 = pd.read_csv(DATA_PATH / DATASET_FNAME4, index_col=0)
except IOError as e:
...
basic_features = ['acc_phone_x','acc_phone_y','acc_phone_z','hr_watch_rate']
